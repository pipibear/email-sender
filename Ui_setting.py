...
# Form implementation generated from reading ui file 'F:\python\email\setting.ui'
#
...
"}")
    ...
    def retranslateUi(self, DlgSetting):
        ...
        DlgSetting.setWindowTitle(_translate("DlgSetting", "设置"))
        self.btn_ok.setText(_translate("DlgSetting", "确定"))
        self.btn_cancel.setText(_translate("DlgSetting", "取消"))
        self.chk_min_tray.setText(_translate("DlgSetting", "最小化到系统托盘"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_common), _translate("DlgSetting", "常用"))
